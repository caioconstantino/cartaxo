...
export const onlineOrder = {
    ...
    actions: {
        ...
        updateShippingInfos: function (context, payload) {
            return new Promise((resolve, reject) => {
                // Certifique-se de que a URL completa seja usada (adicione o domínio se necessário)
                axios.put('admin/online-order/update-shipping-info', payload)
                    .then((res) => {
                        context.commit('show', res.data.data);
                        resolve(res);
                    })

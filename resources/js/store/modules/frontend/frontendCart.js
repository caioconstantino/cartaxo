...
export const frontendCart = {
                ...
                if (Object.keys(payload).length > 0) {
                    ...
                    if (isNew) {
                        context.state.lists.push({
                            ...
                            weight: payload.weight, // Certifique-se de incluir o peso
                            height: payload.height, // Certifique-se de incluir a altura
                            width: payload.width, // Certifique-se de incluir a largura
                            length: payload.length, // Certifique-se de incluir o comprimento
                            total_tax: 0,
                            subtotal: 0,
                            total: 0,
    ...
    mutations: {
        ...
        UPDATE_SHIPPING_CHARGE(state, value) {
        ...
        UPDATE_SHIPPING_METHOD(state, value) {
            state.shippingMethod = value;
        },
        shippingMethod: function (state, payload) {
            if (state.orderType === orderTypeEnum.DELIVERY) {
                state.shippingMethod = payload.setting.shipping_setup_method;
            } else {

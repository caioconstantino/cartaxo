    ...
    <form class="w-full p-6" @submit.prevent="signup">
      ...
      <div class="mb-6">
        ...
        <input
          ...
          @input="formatCpfCnpj"
          :class="errors.cpfcnpj ? 'invalid' : ''"
          id="formCpfCnpj"
          type="text"
          maxlength="18"
          class="w-full h-12 px-4 rounded-lg text-base border border-[#D9DBE9] hover:border-primary/30 focus-within:border-primary/30 transition-all duration-500"
        />
        <small class="db-field-alert" v-if="errors.cpfcnpj">{{
          errors.cpfcnpj[0]
        }}</small>
      </div>
...
export default {
  ...
  methods: {
    ...
    formatCpfCnpj() {
      let value = this.onlyNumbers(this.form.cpfcnpj);
    ...
    signup: function () {
      try {
        ...
        this.form.cpfcnpj = this.onlyNumbers(this.form.cpfcnpj);

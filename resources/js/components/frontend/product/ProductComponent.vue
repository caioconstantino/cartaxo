        ...
        <div class="container">
            ...
            <div class="flex items-center justify-between gap-5 mb-6 max-md:mb-8">
                <div class="flex flex-wrap items-end gap-3 max-md:flex-col max-md:items-start max-md:gap-1.5">
                    <h3 class="text-3xl font-bold capitalize max-sm:text-lg text-primary">
                        {{ $t('label.explore_all_products') }}
                    </h3>
                    <span class="text-xl font-medium capitalize max-sm:text-sm text-white">
                        ({{
            ...
            <div class="flex items-start border-t border-gray-100 max-md:border-none">
                <div id="filter-canvas"
                    ...
                    <div
                        class="w-[270px] ltr:md:border-r rtl:md:border-l md:border-gray-100 max-md:w-full max-md:max-w-xs max-md:transition-all max-md:duration-500 max-md:-translate-x-full">
                        <div class="max-md:h-dvh max-md:overflow-y-auto">
                            <div
                                ...
                                <h3 class="text-[22px] font-bold capitalize text-primary">{{ $t('label.filter_and_sorting') }}</h3>
                            ...
                            <div class="filter-group border-b border-gray-100">
                                <button :key="'eventSortBy'" @click.prevent="colspanHideShow($event, 'sortBy')"
                                    ...
                                    <span
                                        class="text-white text-lg font-semibold capitalize transition-all duration-500 group-hover:text-primary">{{
                                            $t('label.sort_by')
                                        }}</span>
                                    <i
                                ...
                                <div :key="'eventSortById'" id="sortBy"
                                    ...
                                    <div class="w-full mb-6 flex flex-col gap-4 px-6 md:px-0">
                                        <label for="sortByNewest" class="flex items-center gap-3 cursor-pointer group">
                                            ...
                                            <span
                                                class="text-white font-medium capitalize transition-all duration-500 group-hover:text-primary">
                                                {{ $t('label.newest') }}
                                            </span>
                                        </label>

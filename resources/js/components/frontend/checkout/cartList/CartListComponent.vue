    ...
    <div class="row">
        <div class="col-12 lg:col-8">
            ...
            <div class="text-right">
                <router-link :to="{name : 'frontend.checkout.checkout'}" class="max-lg:hidden field-button w-fit font-semibold tracking-wide normal-case">Finalizar Compra</router-link>
            </div>
        </div>
        ...
        <div class="col-12 lg:col-4">
            ...
            <router-link :to="{ name : 'frontend.checkout.checkout' }" class="max-lg:block hidden field-button mt-6 font-semibold tracking-wide normal-case">Finalizar Compra</router-link>
        </div>
    </div>
</template>

        ...
        <div
            ...
            <div class="px-3 pb-10">
                ...
                <nav class="flex flex-wrap items-center gap-6 mb-7"
                    ...
                    <a target="_blank" href="https://www.tiktok.com/@lojacartaxo.online?lang=pt-BR"
                    class="w-7 h-7 !leading-7 text-center rounded-full text-sm !text-heading bg-slate-200 transition-all duration-300 hover:text-white hover:bg-primary">
                    <i class="fa-brands fa-tiktok"></i>
                    </a>
                    <a target="_blank" href="https://www.youtube.com/@LojaCartaxo-r7s"
                    class="w-7 h-7 !leading-7 text-center rounded-full text-sm !text-heading bg-slate-200 transition-all duration-300 hover:text-white hover:bg-primary">

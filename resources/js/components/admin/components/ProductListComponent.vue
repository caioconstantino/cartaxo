<template>
    <div v-if="products.length > 0" v-for="product in products"
        ...
        <div class="px-1 sm:px-0 pt-4 pb-2">
            <h3
                class="text-primary capitalize text-base font-semibold whitespace-nowrap mb-1.5 transition-all duration-300 hover:text-primary overflow-hidden">
                {{ product.name }}
            </h3>
        ...
        $t('label.review') }})</span>
            ...
            <h4 class="text-xl sm:text-[22px] font-bold text-white" v-else>

            ...
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-12">
                        <label for="codebar" class="db-field-title">Código de Barras</label>
                        <input v-model="props.form.codebar" v-bind:class="errors.codebar ? 'invalid' : ''" type="text"
                            id="codebar" name="codebar" class="db-field-control">
                        <small class="db-field-alert" v-if="errors.codebar">{{ errors.codebar[0] }}</small>
                    </div>
                    ...
                    <div class="form-col-12 sm:form-col-4">
                        <label for="height" class="db-field-title">
                            Altura
                        </label>
                        <input v-model="props.form.height" v-bind:class="errors.height ? 'invalid' : ''" type="text"
                            id="height" class="db-field-control">
                        <small class="db-field-alert" v-if="errors.height">
                            {{ errors.height[0] }}
                        </small>
                    </div>

                    <div class="form-col-12 sm:form-col-4">
                        <label for="width" class="db-field-title">
                            Largura
                        </label>
                        <input v-model="props.form.width" v-bind:class="errors.width ? 'invalid' : ''" type="text"
                            id="width" class="db-field-control">
                        <small class="db-field-alert" v-if="errors.width">
                            {{ errors.width[0] }}
                        </small>
                    </div>

                    <div class="form-col-12 sm:form-col-4">
                        <label for="length" class="db-field-title">
                            Comprimento
                        </label>
                        <input v-model="props.form.length" v-bind:class="errors.length ? 'invalid' : ''" type="text"
                            id="length" class="db-field-control">
                        <small class="db-field-alert" v-if="errors.length">
                            {{ errors.length[0] }}
                        </small>
                    </div>

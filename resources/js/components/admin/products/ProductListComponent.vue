                ...
                <table class="db-table stripe" id="print">
                    ...
                    <tbody class="db-table-body" v-if="products.length > 0">
                        <tr class="db-table-body-tr" v-for="product in products" :key="product">
                            <td class="db-table-body-td" @click="copySlug(product.slug)">
                            ...
                            <td class="db-table-body-td hidden-print"
                                ...
                                <div class="flex justify-start items-center sm:items-start sm:justify-start gap-1.5">
                                    <SmCopySlugComponent @click="copySlug('product.slug')" />
...
import SmCopySlugComponent from "../components/buttons/SmCopySlugComponent";
...
export default {
    ...
    methods: {
        ...
        navigator.clipboard.writeText('https://lojacartaxo.com.br/product/' + slug).then(() => {
        alertService.successFlip('copy', 'LINK COPIADO COM SUCESSO');
        console.log('Slug copiado para a área de transferência!');
        }).catch(err => {
        console.error('Erro ao copiar o slug:', err);
        });
        ...
        edit: function (product) {
            ...
            this.props.form.height = product.height;
            this.props.form.width = product.width;
            this.props.form.length = product.length;

...
Route::prefix('bling')->group(function () {
    Route::post('/oauth/refresh', [BlingController::class, 'refresh']);
    Route::post('/nfe/emitir',    [BlingController::class, 'emitir']);
    Route::post('/nfe/{id}/enviar', [BlingController::class, 'enviar']);
    Route::post('/nfe/emitir-enviar', [BlingController::class, 'emitirEEnviar']);
    Route::post('/nfe/pdfNfe', [BlingController::class, 'pdfNfe']);
});

Route::prefix('correio')->group(function () {
    Route::post('/gera-etiqueta', [CorreioController::class, 'gerarRotulo']);
    Route::get('/download-etiqueta/{idRecibo}', [CorreioController::class, 'downloadEtiqueta']);
});
...
Route::prefix('admin')->name('admin.')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('online-order')->name('onlineOrder.')->group(function () {
        ...
        Route::put('/update-shipping-info', [OnlineOrderController::class, 'updateShippingInfos']);
    });
